          ...
          {workspaces.map((ws) => {
            ...
            return (
              <div key={ws.id} className="relative group w-full flex justify-center">
                ...
                <div
                  className={`absolute left-0 top-3.5 w-1 rounded-r-full bg-indigo-500 transition-all duration-300 ${isActive ? 'h-5' : 'h-0 group-hover:h-3'
                    }`}
                />
                ...
                <button
                  ...
                  className={`w-12 h-12 rounded-2xl font-black text-sm flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95 shadow-md ${isActive
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <div className="relative group w-full flex justify-center">
          <button
            ...
            className="w-12 h-12 rounded-full bg-slate-900/40 hover:bg-indigo-500/10 hover:text-indigo-400 border border-dashed border-slate-800 hover:border-indigo-500/40 text-slate-400 hover:text-white flex items-center justify-center cursor-pointer transition duration-200 hover:scale-105 active:scale-95"
            title="Create in Dashboard"
          >
            <Plus size={18} />
          </button>
